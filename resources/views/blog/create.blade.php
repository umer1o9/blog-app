                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title" placeholder="My Blog" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="read_time">Read Time</label>
                                            <input type="text" class="form-control" name="read_time" id="read_time" placeholder="2 min" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="meta_data">Meta Data</label>
                                            <input type="text" class="form-control" name="meta_data" id="meta_data" placeholder="Enter Meta Data" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" id="description" placeholder="Description for Admin Use" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
